...
(ref:semanticpriming-posteriorpredictivechecks-allpriors-exgaussian) Posterior predictive checks for the (ex-Gaussian) models from the semantic priming study. $y$ = observed data; $y_{rep}$ = predicted data.
